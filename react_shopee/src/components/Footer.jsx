        ...
        <div class="container">
            <div className="footer_conten">
                ...
                <div className="footer-section">
                    <h4>Ikuti Kami</h4>
                    <ul>
                        <li><i class="bi bi-facebook"></i> <a href="https://facebook.com/ShopeeID">Facebook</a></li>
                        <li><i class="bi bi-instagram"></i> <a href="https://instagram.com/Shopee_ID">Instagram</a></li>
                        <li><i class="bi bi-twitter"></i> <a href="https://twitter.com/shopeeid">Twitter</a></li>
                        <li><i class="bi bi-youtube"></i> <a href="https://twitter.com/shopeeid">YouTube</a></li>
                        <li><i class="bi bi-linkedin"></i> <a href="https://linkedin.com/company/shopee">Linkedin</a></li>
                    </ul>
                </div>
                <div className="footer-section">
                    ...
                    <div className="payment-icons">
                        ...
                        <img src="../gambar_1/alfamidi.png" alt="Alfamidi" />
                        <img src="../gambar_1/bca.png" alt="BCA" />
                        <img src="../gambar_1/american_express.png" alt="American express" />
                        <img src="../gambar_1/bsi.png" alt="BSI" />
                        <img src="../gambar_1/indomaret.png" alt="Indomaret" />
                        <img src="../gambar_1/mandiri.png" alt="Mandiri" />
                    </div>
                </div>
                <div className="footer-section">
